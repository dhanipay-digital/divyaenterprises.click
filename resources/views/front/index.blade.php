    ...
    <div class="container">
      <div class="header-row">
        <div class="header-column justify-content-start"> 
          ...
          <!-- Logo
          ============================================= -->
          <div class="logo me-2 me-lg-3"> <a href="index.html" class="d-flex" title="Quickai - HTML Template"><img style="width: 300px;height:60px;" src="images/logo.png" alt="Quickai" /></a> </div>
          <!-- Logo end --> 
        ...
        <div class="header-column justify-content-end"> 
              ...
              <ul class="navbar-nav">
                      ...
                      <div class="row">
                        <div class="col-lg"> <span class="sub-title">Hotels</Span>
                          <ul class="dropdown-mega-submenu">
                            ...
                            <li><a class="dropdown-item" href="booking-hotels-confirm-details.html">Hotel Confirm Details</a></li>
                ...
                <li class="dropdown"> <a class="dropdown-toggle" href="#">Pages</a>
                  <ul class="dropdown-menu">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="{{ url('/login') }}">Login/Signup</a>
                      <ul class="dropdown-menu">
          ...
          <nav class="login-signup navbar navbar-expand">
            <ul class="navbar-nav">
              <li class="profile"><a href="{{ url('/login') }}" class="pe-0" title="Login / Sign up"><span class="d-none d-sm-inline-block">Login / Sign up</span> <span class="user-icon ms-sm-2"><i class="fas fa-user"></i></span></a></li>
            </ul>
          </nav>
        </div>
      </div>
  ...
  <div id="content"> 
    ...
    <div class="bg-secondary">
      <div class="container">
        <ul class="nav secondary-nav">
          <li class="nav-item"> <a class="nav-link active" href="index.html"><span><i class="fas fa-mobile-alt"></i></span> Mobile</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-dth.html"><span><i class="fas fa-tv"></i></span> DTH</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-datacard.html"><span><i class="fas fa-credit-card"></i></span> DataCard</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-broadband.html"><span><i class="fas fa-wifi"></i></span> Broadband</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-landline.html"><span><i class="fas fa-phone"></i></span> Landline</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-cabletv.html"><span><i class="fas fa-plug"></i></span> CableTv</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-electricity.html"><span><i class="fas fa-lightbulb"></i></span> Electricity</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-metro.html"><span><i class="fas fa-subway"></i></span> Metro</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-gas.html"><span><i class="fas fa-flask"></i></span> Gas</a> </li>
          <li class="nav-item"> <a class="nav-link" href="recharge-bill-water.html"><span><i class="fas fa-tint"></i></span> Water</a> </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      <section class="section bg-white shadow-md rounded px-5">
        <h2 class="text-9 fw-600 text-center">Refer & Earn</h2>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-7 col-lg-6">
            <h2 class="text-9 fw-600 my-4">Download Our Quickai<br class="d-none d-lg-inline-block">
              Mobile App Now</h2>
            ...
            <div class="d-flex flex-wrap pt-2"> <a class="me-4" href=""><img alt="" src="images/app-store.png"></a><a href=""><img alt="" src="images/google-play-store.png"></a> </div>
          </div>
        </div>
      </div>
    </section>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="footer-copyright">
        ...
        <p class="copyright-text">Copyright © 2022 <a href="#">Quickai</a>. All Rights Reserved.</p>
      </div>
    </div>
  </footer>
  <!-- Footer end --> 
      ...
      <div class="modal-body py-4 px-0">
        ...
        <div class="row">
          <div class="col-11 col-md-10 mx-auto">
            ...
            <p class="text-2 text-center mb-0">Already have an account? <a class="btn-link" href="{{ url('/login') }}" >Log In</a></p>
          </div>
        </div>
        <!-- Sign Up Form End --> 
      </div>
